...
from src.nets.graph_decoder import GraphDecoder
from src.nets.graph_encoder import GraphAttentionEncoder
...
class TSPModel(nn.Module):
    def __init__(
        ...
        Args:
            ...
            embed_dim (int): Size of a vector in the embedding space.
        ...
        self.decoder = GraphDecoder(
            embed_dim=embed_dim, num_heads=8, v_dim=embed_dim, k_dim=embed_dim
        )
